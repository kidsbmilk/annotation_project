...
public final class AttributeKey<T> extends AbstractConstant<AttributeKey<T>> {
    //参考Attribute.java，Attribute的key()就返回AttributeKey<T>类型。

    /**
     * 说明：ConstantPool是一个泛型抽象类，其中newConstant是一个抽象方法，在这里，是创建了一个匿名类ConstantPool<AttributeKey<Object>>的实例，
     * 并将其赋值给了pool。（之前没有注意到这一点。）
     */
