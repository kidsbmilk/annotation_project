...
public class Bootstrap extends AbstractBootstrap<Bootstrap, Channel> {
    ...
    private ChannelFuture doResolveAndConnect(final SocketAddress remoteAddress, final SocketAddress localAddress) {
        ...
        final Channel channel = regFuture.channel(); // 这里相当于一个get方法，返回实例，实例的创建在initAndRegister()中完成了
    ...
    void init(Channel channel) throws Exception {
        ...
        /**
         * 从EchoClient.Java分析到这里，将ChannelHandler添加到Pipeline中，而handler()返回的是handler其实就是
         * 我们在初始化Bootstrap时调用handler设置的ChannelInitializer实例，因此这里就是将ChannelInitializer插入到Pipeline的末端。
         */
