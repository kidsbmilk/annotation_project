 ...
 * triggering an event outside the handler methods, even from a different thread.（注意这里！）
 * <pre>
 ...
 * {@link ChannelPipeline}s more than once.（注意这里！）
 * <p>
...
public interface ChannelHandlerContext extends AttributeMap, ChannelInboundInvoker, ChannelOutboundInvoker {
    ...
    /**
     * 每个ChannelHandlerContext中关联着一个ChannelHandler
     */
    ...
    // 这些是重写了ChannelInboundInvoker中的方法
    @Override
    ...
    // 这两个是重写了ChannelOutboundInvoker中的方法。
    @Override
