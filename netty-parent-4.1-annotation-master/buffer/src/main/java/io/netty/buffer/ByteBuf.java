...
/**
 * A random and sequential accessible sequence of zero or more bytes (octets（1 octet = 8 bit).
 ...
 * {@link #readerIndex() readerIndex} is {@code 0}.（移动内容到前面）
 *
 * <pre>
 ...
 * depending on the underlying buffer implementation.（注意这里的说明！！！）
 *
 ...
 * 可以仔细读一读上面的英文注释。
 */
@SuppressWarnings("ClassMayBeInterface") /*忽略ClassMayBeInterface警告*/
