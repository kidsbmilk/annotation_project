 ...
 *
 * 这个类是由已有的ByteBuf实例，创建一个WrappedByteBuf实例，有什么用呢 ?zz?，难道是为了能通过继承WrappedByteBuf来方便在ByteBuf上增加其他操作 ?zz?
 *
 * UnreleasableByteBuf就是通过继承WrappedByteBuf来方便在ByteBuf上增加其他操作、实现其他功能的，还有SimpleLeakAwareByteBuf等等。
 */
